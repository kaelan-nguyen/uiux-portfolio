      ...
      <div className="fixed inset-0 w-screen h-screen z-0" style={{ overflow: 'hidden' }}>
        <div onWheel={(e) => e.preventDefault()}>
          ...
          />
             ...
             {/* Hero Section */}
                                                               <section className="fade-in relative z-10 pointer-events-none flex items-start justify-center h-full pt-32">
        <div className="text-center w-fit mx-auto">
          <h1 className="text-6xl md:text-8xl font-medium mb-6 font-work-sans text-white glow-text w-fit mx-auto pointer-events-auto">
            Kaelan Nguyen
          </h1>
          <p className="text-xl md:text-2xl text-text-secondary leading-relaxed slide-up font-work-sans w-fit mx-auto pointer-events-auto mb-8">
          ...
          <div className="slide-up text-center pointer-events-auto w-fit mx-auto">
            <Link href="/projects" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all duration-300 group">
              <span className="text-lg font-cascadia-mono">VIEW PROJECTS</span>
              <svg
